...
st.set_page_config(page_title= "Youtube Data Harvesting and Warehousing | By Dhivya",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This app is created by *Dhivya!*"""})
...
api_key = "AIzaSyBavp7dqTSgZAJqpyrZjcBERKQ1o"
